...
//    viewHolder.symbol.setContentDescription(symbol);
    ...
    if (Utils.showPercent){
      ...
      String priceChange = cursor.getString(cursor.getColumnIndex("change"));
      viewHolder.change.setText(priceChange);
      viewHolder.change.setContentDescription(mContext.getString(R.string.a11y_price_change, priceChange));
    }
  }
